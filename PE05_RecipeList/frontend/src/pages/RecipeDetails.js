...
function RecipeDetails() {
    ...
    useEffect(() => {
    axios.get(`https://zany-invention-g4567w4jvr5qh9r6-5000.app.github.dev/recipes/${id}`)
        .then(res => setRecipe(res.data))
    .catch(err => console.log(err));
    }, [id]);
    const handleDelete = () => {
        axios.delete(`https://zany-invention-g4567w4jvr5qh9r6-5000.app.github.dev/recipes/${id}`)
            .then(() => navigate('/'))
            .catch(err => console.log(err));
    };
